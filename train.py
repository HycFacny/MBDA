...
def main(args: argparse.Namespace):
    ...
    model = MBDAPoseResNet(backbone, upsampling, 256, num_keypoints, num_head_layers=args.num_head_layers, finetune=True).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--log", type=str, default='MBDA',
